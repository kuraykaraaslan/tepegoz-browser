...
| [0041](0041-developer-settings-surface.md)         | Developer settings surface — one dev-only place for every knob; allowlist-only Chromium flags; renderer-boundary keys locked | Accepted (Tier B shipped; A/C/D owed)   |
