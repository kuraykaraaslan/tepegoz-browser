...
| AI-3 | [phase-ai-3-agent-loop.md](phase-ai-3-agent-loop.md) | Planner-as-validator loop + progress memory + state-every-step | AI-1 | 🟡 In progress (PR1 landed: progress-brain decision fields + transient page-state collapse. PR2: planner-as-validator cadence + stale-DOM guard) |
