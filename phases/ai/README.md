...
v2's own M1 close condition pre-registered a humility clause: *"if the full baseline disagrees with this
plan's failure ranking, re-cut C1..C5 rather than defend the document."* The one DoD-model signal that
...
Retiring the *documents* retired no *code*. M1's measurement backbone (cost, wall-clock, Wilson CIs,
