...
- [ ] *Risk:* Turkish TTS quality is uneven + voice could become an injection vector → OS-native TTS default +
...
- [ ] *Risk (ADR-0023):* voice is a weaker authenticator + Turkish-dialect STT is imperfect → spoken-nonce is a
...
- [ ] *Risk:* a guardian could be socially engineered into over-permissioning → the Guarded profile can never
