...
| S10 | [phase-s10-vision-escalation.md](phase-s10-vision-escalation.md) | Escalation-only vision (ADR-0008): triggers, budgeted downscale, set-of-marks | S1; gate from S0 | 🟡 **PR0–PR2 landed** 2026-08-19 (vision + negative-control fixtures frozen, ASR battery untouched; gate recorded as OPEN — capability ships inert behind `TEPEGOZ_VISION`; deterministic triggers + escalation-rate now measurable per step) |
