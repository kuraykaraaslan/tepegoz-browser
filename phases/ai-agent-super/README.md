...
| S6 | [phase-s6-safety-control-plane.md](phase-s6-safety-control-plane.md) | Autonomy-to-main (bug fix), risk tiers, `follow_a_plan` grants, advisory critic, strict-mode, ASR battery, credential broker | S0 (PR1 early); S3 (claim ASR) | 🟡 **PR0–PR2 landed** 2026-08-16 (exam frozen; autonomy defect closed; six derived risk tiers + TR-covering sensitive-site map — all deterministic, no sweep owed). PR3–PR7 not started |
