...
- **Owner decisions owed** (none of these are mine to take):
  1. Does this become a numbered phase, fold into
     [Phase 2c](../product/phase-2c-classic-browser-essentials.md), or stay a track?
...
[`phase-1a-walking-skeleton-mvp.md`](../product/phase-1a-walking-skeleton-mvp.md) line 67 marks the
