...
| [protocol-tepegoz-pages.md](protocol-tepegoz-pages.md) | 🟡 **In progress** (Faz 0, 2026-08-26) | Serving `tepegoz://` internal pages (settings first) as real pages via `protocol.registerSchemesAsPrivileged` + `protocol.handle` — socketless. Promoted and accepted 2026-08-26 as the chosen path (Ek A of the Express proposal below). |
