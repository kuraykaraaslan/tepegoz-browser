...
| 2c    | [phase-2c-classic-browser-essentials.md](product/phase-2c-classic-browser-essentials.md)         | Classic browser essentials + downloads (find/print/PDF/reader/translate/bookmarks/private/permissions) — parallel with Phase 2/2b                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 🟡 In progress — 2026-08-28: omnibox+menu **zoom indicator**, built-in **PDF viewer**, download **speed/ETA + retry**, **ADR-0040** (Download Trust Model) accepted. 2026-09-01: **ADR-0042** (Page-Translation — hybrid: local default, cloud per-origin opt-in) and **ADR-0043** (Safe Browsing — direct to Google SB v5, on by default, one Settings switch) accepted on owner calls. Translation sensitive-site cloud lockout **wired** 2026-09-01. Still owed for ✅: the translation **agent-run untranslated-source guarantee**, and **build the `SafeBrowsingService`** (prefix DB + refresh + v5 client + nav check + `DownloadTrustProvider` + Settings switch; needs a free-tier Google API key provisioned).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
