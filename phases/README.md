...
| 2b    | [phase-2b-daily-driver-ux.md](product/phase-2b-daily-driver-ux.md)                               | Daily-driver browser UX (tabs/PWA/DevTools) — parallel with Phase 2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | 🟡 In progress — **the v1 ship line's narrow scope (default-browser registration, tab discard/sleep, tab groups) is now code-complete** (2026-08-26); DevTools boundary + ADR-0029 landed earlier; PWA/split-view/workspaces/full session restore remain, all frozen out of v1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 2c    | [phase-2c-classic-browser-essentials.md](product/phase-2c-classic-browser-essentials.md)         | Classic browser essentials + downloads (find/print/PDF/reader/translate/bookmarks/private/permissions) — parallel with Phase 2/2b                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 🟡 In progress (download/clipboard/upload manager slices; page-command shortcuts; user-facing screenshot capture + a find-bar tab-switch resync fix landed 2026-08-26)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
