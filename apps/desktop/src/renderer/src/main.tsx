...
import { DeveloperPageSurface } from './components/DeveloperPageSurface';
import { ProfilesPageSurface } from './components/ProfilesPageSurface';
...
else if (internalPageHost === 'developer') node = <DeveloperPageSurface />;
else if (internalPageHost === 'profiles') node = <ProfilesPageSurface />;
