...
results" copy); the page title reuses the shared core dict's `common.settings`. Section _content_ —
  ...
  sections={[
    {
      ...
      label: t.general,
      icon: <Icon name="home" />,
      searchText: 'general theme language',
    ...
    },
    {
      ...
      label: t.privacy,
      icon: <Icon name="lock" />,
      searchText: 'privacy cookies',
      content: <ComingSoonCard title={t.privacy} />,
    },
  ]}
/>
```
