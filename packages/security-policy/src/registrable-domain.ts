...
const MULTI_PART_SUFFIXES: ReadonlySet<string> = new Set([
  ...
  'com.tr', 'net.tr', 'org.tr', 'gov.tr', 'edu.tr', 'bel.tr', 'av.tr', 'dr.tr',
  'k12.tr', 'pol.tr', 'mil.tr', 'tsk.tr', 'gen.tr', 'biz.tr', 'info.tr', 'tv.tr',
  'web.tr', 'name.tr', 'tel.tr', 'bbs.tr',
  // United Kingdom
  'co.uk', 'org.uk', 'me.uk', 'ltd.uk', 'plc.uk', 'net.uk', 'sch.uk', 'ac.uk', 'gov.uk', 'nhs.uk',
  // Australia / New Zealand / South Africa
  'com.au', 'net.au', 'org.au', 'edu.au', 'gov.au', 'id.au', 'co.nz', 'org.nz', 'co.za', 'org.za',
  // Japan / Korea / China / Taiwan / Hong Kong / Singapore
  'co.jp', 'or.jp', 'ne.jp', 'ac.jp', 'go.jp', 'co.kr', 'or.kr',
  'com.cn', 'net.cn', 'org.cn', 'gov.cn', 'com.tw', 'com.hk', 'com.sg', 'com.my',
  // South & Southeast Asia
  'co.in', 'net.in', 'org.in', 'gov.in', 'co.th', 'com.ph', 'com.vn', 'co.id',
  // Americas / Europe / Middle East
  'com.br', 'net.br', 'org.br', 'gov.br', 'com.mx', 'com.ar', 'com.co',
  'co.il', 'com.pl', 'com.ua', 'com.ru', 'co.ru',
]);
