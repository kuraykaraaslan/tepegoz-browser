...
export const tr: ChatUiStrings = {
  ...
  workspace: {
    ...
    mute: 'Sessize al',
    unmute: 'Sesi aç',
    muteFor1h: '1 saat sessize al',
    muteFor3h: '3 saat sessize al',
    muteFor8h: '8 saat sessize al',
    muteForever: 'Süresiz sessize al',
    archive: 'Arşivle',
    unarchive: 'Arşivden çıkar',
    showArchived: 'Arşivi göster',
    backToChats: 'Sohbetlere dön',
  ...
  newChat: {
    ...
    addressLabel: 'Adres',
    addressPlaceholder: 'kullanici@ornek.org',
