...
export const SkillsIcon = ({ className }: { className?: string }) => (
  <Svg className={className}>
    <path d="M4 5.5A2.5 2.5 0 016.5 3H19v15H6.5A2.5 2.5 0 004 20.5zM19 18v3H6.5" />
  </Svg>
);
export const NewTaskIcon = ({ className }: { className?: string }) => (
  <Svg className={className}>
...
export const HistoryIcon = ({ className }: { className?: string }) => (
  <Svg className={className}>
    <path d="M3 12a9 9 0 109-9M3 3v6h6M12 7v5l3 2" />
  </Svg>
);
...
export const AskIcon = ({ className }: { className?: string }) => (
  <Svg className={className}>
    <path d="M8 12V7a2 2 0 114 0M6 12V9a2 2 0 114 0m0-1a2 2 0 114 0v1m0-1a2 2 0 114 0v6a5 5 0 01-5 5h-2a5 5 0 01-4-2l-3-4a2 2 0 013-2l2 1.5" />
  </Svg>
);
export const ActIcon = ({ className }: { className?: string }) => (
  <Svg className={className}>
